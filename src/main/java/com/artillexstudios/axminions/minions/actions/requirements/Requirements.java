...
public final class Requirements {
    private static final HashMap<String, BiFunction<MapConfigurationGetter, List<Effect<Object, Object>>, Requirement>> requirements = new HashMap<>();
    ...
    public static void register(String id, BiFunction<MapConfigurationGetter, List<Effect<Object, Object>>, Requirement> supplier) {
        requirements.put(id.toLowerCase(Locale.ENGLISH), supplier);
    }

    public static Requirement parse(String id, MapConfigurationGetter configuration, List<Effect<Object, Object>> elseEffect) {
        BiFunction<MapConfigurationGetter, List<Effect<Object, Object>>, Requirement> effectSupplier = requirements.get(id.toLowerCase(Locale.ENGLISH));
